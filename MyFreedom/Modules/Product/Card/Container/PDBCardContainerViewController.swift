//
//  PDBCardContainerViewController.swift
//  MyFreedom
//
...
class PDBCardContainerViewController: BaseViewController {
    
    var router: PDBCardContainerRouterInput?
    var interactor: PDBCardContainerInteractorInput?
...
extension PDBCardContainerViewController: PDBCardContainerViewInput {
    ...
    func routeToLimits() {
        router?.routeToLimits()
    }

    func routeToOrder(type: OrderPlasticCardType) {
        router?.routeToOrder(type: type)
    }

    func routeToIncomeCard() {
        router?.routeToIncomeCard()
    }
}

extension PDBCardContainerViewController: UITableViewDataSource, UITableViewDelegate {
...
extension PDBCardContainerViewController: SwitchFieldViewDelegate {
...
extension PDBCardContainerViewController: PDBannerViewDelegate {
    
    func didSelectItem(at indexPath: IndexPath) {
        interactor?.didSelectItemBanner(at: indexPath)
    }
}

// MARK: - BSheetScrollProtocol
extension PDBCardContainerViewController {
