...
class BiometryPadItemCell: UICollectionViewCell {
    ...
    private let imageView: UIImageView = build {
        ...
        $0.image = Biometric().biometricType.icon?.template
    }
...
extension BiometryPadItemCell: PadItemCellTappable {
