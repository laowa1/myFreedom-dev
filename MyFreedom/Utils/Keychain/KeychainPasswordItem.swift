...
struct KeychainPasswordItem {
    ...
    enum KeychainError: Error {
        ...
        var description: String {
            let errorCommonStartText = "Произошла ошибка."
            switch self {
            case .noPassword:
                return errorCommonStartText
                    + " Пароль быстрого доступа не установлен."
                    + " Попробуйте авторизоваться заново."
            case .unexpectedPasswordData:
                return errorCommonStartText + " Попробуйте авторизоваться заново."
            case .unexpectedItemData:
                return errorCommonStartText
            case .unhandledError(let status):
                return errorCommonStartText + " Попробуйте авторизоваться заново. Код ошибки: \(status)"
            }
        }
    }
